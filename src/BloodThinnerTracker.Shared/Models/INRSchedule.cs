...
namespace BloodThinnerTracker.Shared.Models
{
    ...
    public class INRSchedule : MedicalEntityBase
    {
        ...
        /// <summary>
        /// Gets or sets the INR test ID if test was completed.
        /// </summary>
        public Guid? CompletedTestId { get; set; }
        ...
        /// <summary>
        /// Gets or sets the parent schedule ID for auto-generated follow-ups.
        /// </summary>
