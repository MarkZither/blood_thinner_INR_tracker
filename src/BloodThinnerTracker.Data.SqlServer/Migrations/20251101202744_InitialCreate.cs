        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPointOfCare = table.Column<bool>(type: "bit", nullable: false),
                    WasFasting = table.Column<bool>(type: "bit", nullable: true),
                    LastMedicationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    ReviewedByProvider = table.Column<bool>(type: "bit", nullable: false),
                    ReviewedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ReviewedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PatientNotified = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBloodThinner = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    MinHoursBetweenDoses = table.Column<int>(type: "int", nullable: false),
                    RequiresINRMonitoring = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedTestId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfirmedByProvider = table.Column<bool>(type: "bit", nullable: false),
                    ConfirmedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ConfirmedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TakenWithFood = table.Column<bool>(type: "bit", nullable: true),
                    FoodDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    TimeVarianceMinutes = table.Column<int>(type: "int", nullable: false),
                    PublicId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
