...
public class MedicalNotificationHub : Hub
{
    ...
    public async Task SubscribeToMedicationReminders(List<Guid> medicationIds)
    {
        var userId = GetCurrentUserId();
        if (userId == null)
        {
    ...
    public async Task UnsubscribeFromMedicationReminders(List<Guid> medicationIds)
    {
        var userId = GetCurrentUserId();
        if (userId == null)
        {
    ...
    /// <returns>A task that represents the asynchronous acknowledgment operation.</returns>
    public async Task AcknowledgeINRReminder(Guid scheduleId, Guid? testId = null)
    {
        var userId = GetCurrentUserId();
        if (userId == null)
        {
    ...
    public interface IMedicalNotificationService
{
    ...
    Task SendMedicationReminderAsync(List<Guid> userIds, object reminder);
    ...
    /// <returns>A task that represents the asynchronous send operation.</returns>
    Task SendINRReminderAsync(List<Guid> userIds, object reminder);
    ...
    /// <returns>A task that represents the asynchronous send operation.</returns>
    Task SendCriticalAlertAsync(List<Guid> userIds, object alert);
    ...
    Task NotifyDataSyncAsync(List<Guid> userIds, object syncData);
}
...
public class MedicalNotificationService : IMedicalNotificationService
{
    ...
    /// <inheritdoc />
    public async Task SendMedicationReminderAsync(List<Guid> userIds, object reminder)
    {
        try
        {
    ...
    /// <inheritdoc />
    public async Task SendINRReminderAsync(List<Guid> userIds, object reminder)
    {
        try
        {
            var tasks = userIds.Select(userId =>
    ...
    /// <inheritdoc />
    public async Task SendCriticalAlertAsync(List<Guid> userIds, object alert)
    {
        try
        {
            var tasks = userIds.Select(userId =>
    ...
    /// <inheritdoc />
    public async Task NotifyDataSyncAsync(List<Guid> userIds, object syncData)
    {
        try
        {
            var tasks = userIds.Select(userId =>
